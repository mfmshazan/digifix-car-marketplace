    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.trackingModalContainer}>
          ...
          {Platform.OS === "web" ? (
            <View style={[styles.map, { justifyContent: 'center', alignItems: 'center', backgroundColor: '#F8FAFC' }]}>
              <Ionicons name="map-outline" size={48} color="#94A3B8" />
              <Text style={{ marginTop: 12, color: '#475569', fontSize: 16, fontWeight: '600' }}>
                Map tracking is not available in the web preview.
              </Text>
            </View>
          ) : (
            <NativeMap
